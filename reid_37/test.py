...
#save_dir = 'C:/Users/ojkk3/Documents/Dropbox/person-searching/Person-Tracking-and-Re-ID/deep-reid/reid-data/Test_folder/'
GRID_SPACING = 10
...
#path = 'C:/Users/ojkk3/Test_data/Test_folder/'
q = 'query/'
g = 'gallery/'
data_type = 'image'
...
for i in range(len(query)):
    qimg, q_pid, q_camid = parse_data_for_eval(query)
    qf = extractor(qimg)
    qfs.append(qf)
    q_pids.append(q_pid)
...
for i in range(len(gallery)):
    gimg, g_pid, g_camid = parse_data_for_eval(gallery)
    gf = extractor(gimg)
    gfs.append(gf)
    g_pids.append(g_pid)
...
print(type(dataset))
print(len(dataset))
visualize_ranked_results(distmat,dataset,data_type='image',save_dir=save_dir)